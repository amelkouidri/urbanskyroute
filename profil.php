...
<head>
  ...
  <title>Profil - UrbanSky Route</title>
  ...
  <main id="main">
    ...
    <section class="user-profile">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="user-profile-info" data-aos="fade-up">
              <div class="user-profile-image">
                <img src="profil.jpg" class="img-fluid" alt="Your Profile Picture">
              </div>
              <h2>Serine</h2>
          ...
          <div class="col-lg-8">
            <div class="user-profile-content" data-aos="fade-up">
              <h3>Your Profile</h3>
              <p>Update your profile information, add a bio, and manage your account settings.</p>
